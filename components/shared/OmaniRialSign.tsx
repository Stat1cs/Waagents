...
type OmaniRialSignProps = {
  className?: string;
  /** Accessible label; omit when decorative (parent has title). */
  label?: string;
};

/**
 * Official Omani rial sign (Central Bank of Oman).
 * @see https://en.wikipedia.org/wiki/Omani_rial_sign
 */
export function OmaniRialSign({ className, label }: OmaniRialSignProps) {
  return (
    <svg
