...
const variantOpacity: Record<Variant, { gold: string; navy: string }> = {
  hero: {
    gold: "opacity-[0.07] dark:opacity-[0.09]",
    navy: "opacity-[0.05] dark:opacity-[0.07]",
  },
  cta: {
    gold: "opacity-[0.08] dark:opacity-[0.1]",
    navy: "opacity-[0.06] dark:opacity-[0.08]",
  },
  pricing: {
    gold: "opacity-[0.06] dark:opacity-[0.08]",
    navy: "opacity-[0.05] dark:opacity-[0.06]",
  },
  demo: {
    gold: "opacity-[0.09] dark:opacity-[0.11]",
    navy: "opacity-[0.07] dark:opacity-[0.09]",
  },
};
    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "demo" &&
            "bg-[radial-gradient(ellipse_70%_50%_at_50%_0%,rgba(210,157,61,0.12),transparent_60%),radial-gradient(ellipse_60%_50%_at_0%_100%,rgba(22,47,77,0.1),transparent_55%)]",
          variant === "cta" &&
            "bg-[radial-gradient(ellipse_70%_70%_at_50%_50%,rgba(210,157,61,0.1),transparent_65%),radial-gradient(ellipse_50%_40%_at_0%_100%,rgba(22,47,77,0.12),transparent_60%)]",
          variant === "pricing" &&
            "bg-[radial-gradient(ellipse_60%_50%_at_100%_100%,rgba(22,47,77,0.1),transparent_55%),radial-gradient(ellipse_50%_40%_at_0%_0%,rgba(210,157,61,0.08),transparent_50%)]",
        )}
      />
      ...
      <CornerRosette
        stroke="#C5A059"
        className={cn(
          "absolute -end-6 -top-6 opacity-40 dark:opacity-50",
          variant === "demo" && "opacity-50 dark:opacity-60",
        )}
        mirror={mirror}
      />
      <CornerRosette
        stroke="#1B4D3E"
        className={cn(
          "absolute -bottom-8 -start-8 opacity-35 dark:opacity-45",
          variant === "demo" && "opacity-45 dark:opacity-55",
        )}
        mirror={!mirror}
      />
      {variant === "hero" && (
      ...
      >
        <defs>
          ...
          >
            <RosetteOctagonPattern stroke="#1B4D3E" className={op.navy} />
          </pattern>
        </defs>
