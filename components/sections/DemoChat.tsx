...
import { BRAND_LOGOS, getWhatsAppDemoUrl, TRY_LIVE_MESSAGES, WHATSAPP_CHAT, WHATSAPP_LINK_REL } from "@/lib/constants";
...
export function DemoChat() {
  ...
  const demoUrl = getWhatsAppDemoUrl(
    TRY_LIVE_MESSAGES[hydrated ? activeLocale : initialLocale],
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="overflow-hidden rounded-2xl border border-gold/20 shadow-2xl shadow-forest/20"
        >
          {/* WhatsApp header */}
          <div
